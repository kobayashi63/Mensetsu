...
\({\bf x} : M \hookrightarrow \mathbb{H}^m_s\) : 等長はめ込み
\vspace{3pt}
...
\subsection{in \(\mathbb{S}^{n+1}_1\) or \(\mathbb{H}^{n+1}_1\)}
...
\subsection{in \(\mathbb{S}^{n+1}_2\) or \(\mathbb{H}^{n+1}_2\)}
...
\frame{
 ...
 \hspace{60pt} \(\gamma\) \hspace{25pt} : \hspace{0pt}\(\mathbb{E}^m_1\)のnull曲線 \vspace{3pt}
